...
while running:
    ...
    if command == 'insert' or command == '/i':
        ...
        if insert_type == 'terminal' or insert_type == '/t':
            ...
            with open('LAB11/phone.csv', 'w') as f:
                for i in range(100) :
            ...
            with open('LAB11/phone.csv', 'r') as f :
                data = f.readlines()
            ...
            sql = f"insert into phonebook (name, phone_number) values {','.join(data)};"
            ...
            if pagination == 'yes' or pagination == 'y' :
                ...
                if user == '/all' :
                    ...
                    sql = f'''
                        select *
                        from phonebook
                        where name = \'{user}\' or phone_number = \'{user}\'
                '''
